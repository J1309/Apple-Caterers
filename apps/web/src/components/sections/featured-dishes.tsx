        ...
        <div className="flex flex-col md:flex-row md:items-end justify-between mb-16 gap-6">
          <div className="space-y-4">
            ...
            <h2 className="text-4xl md:text-5xl font-serif text-gray-900">
              Our Signature <span className="italic text-gold">Creations</span>
            </h2>
          </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          {dishes.map((dish, index) => (
            <motion.div
              ...
              viewport={{ once: true }}
              className="group bg-white rounded-3xl overflow-hidden border border-gray-100 shadow-sm hover:border-maroon/30 hover:shadow-md transition-all duration-500"
            >
              ...
              <div className="p-8">
                ...
                <div className="flex items-center justify-between pt-4 border-t border-gray-100">
                  <div className="flex items-center gap-1.5 text-gray-500 text-sm">
                    <Star size={14} className="text-gold fill-[var(--color-gold)]" />
